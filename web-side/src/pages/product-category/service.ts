...
// 新增一个商品类别
export async function addOneProductCategoryRequest(category: API.Product.ProductCategory) {
...
// 更新一个商品类别
export async function updateOneProductCategoryRequest(category: API.Product.ProductCategory) {
